// flux.js
// This file contains the old code base for reference.
// The main entry point for the application is index.js, which serves as the CLI entry point.

console.log(
    'flux.js is now just for reference. Use index.js as the main entry point.'
);
...
//             responseType: 'stream',
//         });
//         const filePath = path.join(currentDir, `${packageName}-${version}.tgz`); // Save in current directory
...
//     try {
//         const extractPath = path.join(currentDir, 'node_modules', packageName); // Use current directory
...
//     const packageJsonPath = path.join(currentDir, 'package.json'); // Use current directory
//     let packageData = {};
